...
deploy-sepolia:
	forge script script/DeployFundMe.s.sol:DeployFundMe --rpc-url $(SEPOLIA_RPC_URL)  --account KeySepolia --sender 0xc31E42C689243c950E85367623Ad7F91A0E68429 --broadcast --verify --etherscan-api-key $(ETHERSCAN_API_KEY) -vvvv
